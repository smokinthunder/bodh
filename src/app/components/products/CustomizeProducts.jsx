  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <ul className="flex items-center gap-3">
        ...
        <li className="ring-1 ring-lama text-black bg-lama rounded-md py-1 px-4 text-sm cursor-pointer">
          Medium
        </li>
        <li className="ring-1 ring-pink-200 text-black bg-black-200 rounded-md py-1 px-4 text-sm cursor-not-allowed">
          Large
        </li>
      </ul>
